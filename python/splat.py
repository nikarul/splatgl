...
create_instance = _bind("Splat_CreateInstance", [POINTER(Splat_Image), POINTER(Splat_Layer), c_int, c_int, POINTER(SDL_Rect), c_int], POINTER(Splat_Instance), _validate_ptr)
...
set_instance_image = _bind("Splat_SetInstanceImage", [POINTER(Splat_Instance), POINTER(Splat_Image), POINTER(SDL_Rect)], c_int, _validate_int)
